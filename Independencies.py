...
class Independencies(object):
    ...
    def closure(self):
        ...
        def sg3(ind1, ind2):
            ...
            # if Y < Y_Z and Z < Y_Z and Y.isdisjoint(Z): # this condition is wrong
            #     return [IndependenceAssertion(ind1.event1, ind1.event2 | Y, Z)]
            # else:
            #     return []
        ...
        while new_inds:
            ...
            s1 = [sg1(ind) for ind in new_inds]
            s2 = [sg2(ind) for ind in new_inds]
            s3 = [sg3(*inds) for inds in new_pairs]
            new_inds = set(
                sum(
